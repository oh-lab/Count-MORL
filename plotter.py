...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--algos', default=["mopo", "LC", "AVG", "UC"], help='algos'
    )
    parser.add_argument(
    ...
    parser.add_argument(
        '--output-path', type=str, help='figure save path', default="./"
    )
    parser.add_argument(
    ...
    if args.output_path:
        plt.savefig(args.output_path + args.task + ".png", dpi=args.dpi, bbox_inches='tight')
    if args.show:
        plt.show()
